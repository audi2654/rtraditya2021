//Date: 11/06/2022
//RTR2021 OGL Teapot Model Loading with Marble Texture
...
#include "teapot.h"			//for teapot model
...
//for lights
GLfloat gfaLightAmbient[] = {0.5f, 0.5f, 0.5f, 1.0f};
GLfloat gfaLightDiffuse[] = {1.0f, 1.0f, 1.0f, 1.0f};
GLfloat gfaLightPosition[] = {0.0f, 0.0f, 2.0f, 1.0f};
BOOL gbLight = FALSE;
...
int initialize(void)
{
	...
	glEnable(GL_TEXTURE_2D);	//enabling the texture
