//Date: 12/03/2022
//RTR2021 OGL White Perspective Projection Blue Screen - Two2DShapes Rotation
...
void display(void)
{
	...
	//try commenting & uncommenting below both lines & see output
	glTranslatef(1.5f, 0.0f, -6.0f);	//previous CTM position RESET translate call
	//glTranslatef(3.0f, 0.0f, 0.0f);		//previous CTM position RELATIVE translate call
