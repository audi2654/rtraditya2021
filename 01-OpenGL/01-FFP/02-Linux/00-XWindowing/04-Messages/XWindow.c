//Date: 01/06/2022
//RTR2021 XWindows Window Messages
...
int main(void)
{
	...
	windowAttributes.event_mask = ExposureMask | KeyPressMask | ButtonPressMask | FocusChangeMask;		//event mask is the member which decides which msgs our wnd should respond to & which it should not, 
	...
	XStoreName(display, window, "AMP Messages XWindow");	//9th Xlib API call
