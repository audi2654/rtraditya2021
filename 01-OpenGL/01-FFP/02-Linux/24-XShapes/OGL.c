...
void amp_draw(void)
{
	...
	//upper second
	glLoadIdentity();
	glTranslatef(-0.4f, 1.0f, -6.0f);

	glBegin(GL_LINES);
	glVertex3f(0.9f, 0.3f, 0.0f);			//horizontal lines
	...
	//glVertex3f(0.9f, 0.3f, 0.0f);			//vertical lines
	//glVertex3f(0.9f, -0.6f, 0.0f);
	...
	glVertex3f(0.9f, 0.3f, 0.0f);			//diagonal lines
	glVertex3f(0.0f, -0.6f, 0.0f);
	...
	glVertex3f(0.0f, 0.3f, 0.0f);			//diagonal lines
	glVertex3f(0.9f, -0.6f, 0.0f);
