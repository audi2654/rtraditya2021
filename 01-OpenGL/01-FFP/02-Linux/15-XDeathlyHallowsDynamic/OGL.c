//Date: 30/06/2022
//RTR2021 OGL XDynamic Deathly Hallows
//with C,T,L keypress movement & A for all shapes to move
...
void amp_update(void)
{
	...
	//code
	//for rotation
	gAngleTriangle = gAngleTriangle + 1.0f;
	gAngleCircle = gAngleCircle + 1.0f;
