//Date: 30/06/2022
//RTR2021 OGL XTextured Perspective Projection Blue Screen - Two3DShapes Rotation
...
int main(int argc, char* argv[], char* envp[])
{
	...
	{
		fprintf(amp_gpFile, "loadGlTexture() for Stone FAILED\n");
		amp_uninitialize();
	}
	else if (retVal == -4)
	{
		fprintf(amp_gpFile, "loadGlTexture() for Kundali FAILED\n");
		amp_uninitialize();
	}
	else
	{
