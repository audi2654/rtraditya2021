...
int main(int argc, char* argv[], char* envp[])
{
	...
	XStoreName(display, window, "AMP OGL PP Blue Screen XPerspective Rectangle with Shaders");
...
int initialize(void)
{
	...
	glBufferData(GL_ARRAY_BUFFER, sizeof(rectangleVertices), rectangleVertices, GL_STATIC_DRAW);		//putting triangleVertices array in vbo in VRAM; GL_STATIC_DRAW means to fill buffer data now or on runtime, for runtime use GL_DYNAMIC_DRAW
