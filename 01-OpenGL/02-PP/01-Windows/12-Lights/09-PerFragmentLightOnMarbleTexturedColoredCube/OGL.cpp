...
GLuint vbo_cube_position;							//vertex buffer object for position
GLuint vbo_cube_color;								//vertex buffer object for color
GLuint vbo_cube_normal;								//vertex buffer object for normal
GLuint vbo_cube_texcoord;							//vertex buffer object for texture
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	hwnd = CreateWindowEx(WS_EX_APPWINDOW,
		szAppName,
		TEXT("AMP RTR PP Window - PCNT Cube with Per Fragment Light & Marble Texture"),
