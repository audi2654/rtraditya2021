//Date: 30/07/2022
//RTR2021 OGL PP Per Fragment Lighting on Static Sphere
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	hwnd = CreateWindowEx(WS_EX_APPWINDOW,
		szAppName,
		TEXT("AMP RTR PP Window - Per Fragment Phong Lighting"),
...
int initialize(void)
{
	...
	//in this program we calculate some light attribute components in Vertex Shader
	...
	//phong_ads_light = AMBIENT + DIFFUSE + SPECULAR; 		//final light is summation of ADS
		...
		//DIFFUSE component is multiplication of 3 things : lightDiffuse (u_ld) & materialDiffuse (u_kd) & dot product of lightDirection & transformedNormal (S.N)
			//4 things are needed to be calculated in shader for diffuse light/component
				...
				//2.normalMatrix -> for transformedNormal (N)
				//3.transformedNormal -> for reflectionVector (to use in SPECULAR compo.)
	...
	//in this program we calculate major light components in Fragment Shader hence this is Per Fragment Lighting
