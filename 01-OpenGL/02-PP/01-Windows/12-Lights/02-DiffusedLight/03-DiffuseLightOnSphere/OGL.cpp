//Date: 05/10/2022
//RTR2021 OGL PP Diffused Light on Static Sphere
...
int initialize(void)
{
	...
	glVertexAttrib3f(AMP_ATTRIBUTE_COLOR, 1.0f, 0.1f, 0.1f);		//when you want only 1 color for whole geometry use this, but for multiple color create vbo for colors
