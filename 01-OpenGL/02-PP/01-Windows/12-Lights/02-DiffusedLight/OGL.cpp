...
GLuint vbo_pyramid_color;								//vertex buffer object for color
...
int initialize(void)
{
	...
	//i.e if 1st values are for front face then all 3 arrays should have 1st values for front face
...
void display(void)
{
	...
	*/
	...
	//sendind light related uniforms
	if(bLight == TRUE)
	{
