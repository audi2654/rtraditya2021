//Date: 17/07/2022
//RTR2021 OGL PP White Perspective Projection Blue Screen - Two3DShapes Cube & Pyramid Rotation
...
int initialize(void)
{
	...
	const GLchar* fragmentShaderSourceCode =
		...
		"in vec4 a_color_out;" \
		"out vec4 FragColor;" \
		"vec4 a_color_white = vec4(1.0, 1.0, 1.0, 1.0);" \
		"void main(void)" \
		"{" \
			"FragColor = a_color_white;" \
		"}";
