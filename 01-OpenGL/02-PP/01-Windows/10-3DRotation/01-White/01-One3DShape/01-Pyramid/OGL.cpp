//Date: 17/07/2022
//RTR2021 OGL PP White Perspective Projection Blue Screen - One3DShape Pyramid Rotation
...
int initialize(void)
{
	...
	//replacing all above line with below single line when only 1 color is to be used
