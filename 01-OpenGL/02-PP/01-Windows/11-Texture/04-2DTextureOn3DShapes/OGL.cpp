//Date: 17/07/2022
//RTR2021 OGL PP TEXTURED Perspective Projection Blue Screen - Two3DShapes Rotation
//Texture of stone on Pyramid & kundali on Cube, 2D Texture on 3D Geometry
...
GLuint vbo_pyramid_texcoord;							//vertex buffer object for texture
...
void display(void)
{
	...
	mat4 scaleMatrix = mat4::identity();			//to scale cube a little bit compared to pyramid
	...
	glBindTexture(GL_TEXTURE_2D, 0);			//unbinding texture_kundali - optional
